...
#include "buffer.h"
#include "Header.h"
#include "tx_rx_Text.h"
#include "tx_rx_Audio.h"
...
int nComRate = 230400;								// Baud (Bit) rate in bits/second (230400 is Speedy).
...
int main()
{	
	//int tmp = tx_rx_Test(COMPORT_Rx, COMPORT_Tx, hComRx, hComTx, nComRate, nComBits, timeout);
	//int tmp = tx_rx_Test();
	...
	case 1:
	{
		...
		//Audio 
		Sender(iBigBufNew, 2*lBigBufSize);
